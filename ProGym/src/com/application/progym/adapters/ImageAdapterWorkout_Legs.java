...
public class ImageAdapterWorkout_Legs extends BaseAdapter{
     ...
     */
    public ImageAdapterWorkout_Legs(Context context, ArrayList<Store_Workout> workouts) {
     ...
     * @param context The Context of the application/object.
     */
    public ImageAdapterWorkout_Legs(Context context)
    {
        inflater = LayoutInflater.from(context);
        this.context = context;
    ...
    private void parseString(String string)
    {
    	try {
			...
			for(Store_Workout workout : allWorkouts.Legs)
			{ 
